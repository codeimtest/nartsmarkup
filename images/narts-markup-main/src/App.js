		...
		<main>
			...
			<div className='first-screen'>
				<Container>
					<Row>
						<Col>
							<h1 className='home-title'><span>NFT's</span></h1>
						</Col>
					</Row>
				</Container>
			</div>
			...
			<Contact />
			<Footer />
			<Connect active={connectActive} setActive={setConnectActive}/>
		</main>
	);
}
...
export const Menu = ({setConnectActive,connectActive }) => (
	<div>
		...
		<div className='toggle-menu'>
			...
			<a href="#" className='main-button bordered'>Allow list</a>
			<button className='main-button' onClick={() => setConnectActive(!connectActive)}>Connect wallet</button>
		</div>
	</div>
);
export const Nft = () => (
				...
				<Col>
					{
						data.Nfts.map((nft) => {
							return (
								<div className="container-feed-masonry">
									{
										nft.nftSet.map((nftDetail) => {
											return (
												<figure>
													<div className='feed-item-more'>
														<div className='hover-toggle-details'>
															<a href="#" className='main-button white'>Allow list</a>
															<a href="#" className='main-button bordered-white'>Learn more</a>
														</div>
														<img src={nftDetail.Thumbnail} />
													</div>
													<div className='feed-item-props'>
														<div className='feed-item-title like-five'>
															{nftDetail.Name}
														</div>
														<div className='feed-item-details'>
															<span>{nft.Author}</span>
															<span>{nftDetail.Year}</span>
														</div>
														<div className='feed-item-price like-three'>
															<div className={nftDetail.Valute} />
...
export const Contact = () => (
	<section style={bgcolors.silver}>
		<Container>
			<Row>
				<Col xl={6} lg={7}>
					<h2 className='special-title'><span>Still have a question?<br />Contact us</span></h2>
					<div className='contact-widgets'>
						<div>
							<p>Telegram</p>
							<a href="#" className='like-three'>@projectname</a>
						</div>
						<div>
							<p>Email</p>
							<a href="#" className='like-three'>albert@projectname.domain</a>
						</div>
					</div>
				</Col>
				<Col xl={6} lg={5}>
...
export const Connect = ({ active, setActive}) => (
		<div className={active ? 'popup-dialog active' : 'popup-dialog'}>
			<div className='popup-dialog-wrap'>
				<div className='like-two'>Connect Wallet</div>
				<div className='wallet-list like-four'>
					<button className='metamask'>
						<img src={metamask}/>
						Metamask
					</button>
					<button className='trustwallet'>
					<img src={trustwallet}/>
						TrustWallet
					</button>
					<button className='mathWallet'>
					<img src={mathwallet}/>
						MathWallet
					</button>
